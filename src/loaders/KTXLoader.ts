...
export class ThreeKTXLoader extends CompressedTextureLoader {
...
export class KhronosTextureContainer {
    ...
    public readonly loadType: number;
    ...
    public readonly glTypeSize: number;
    public readonly glFormat: number;
    public readonly glInternalFormat: number;
    public readonly glBaseInternalFormat: number;
    public readonly numberOfFaces: number;
    public readonly numberOfMipmapLevels: number;
    public readonly numberOfArrayElements: number;
    public readonly bytesOfKeyValueData: number;
     ...
     */
    constructor(arrayBuffer: ArrayBufferLike, facesExpected: number /*, threeDExpected, textureArrayExpected */) {
    ...
    public mipmaps(loadMipmaps: boolean): any[] {
        const mipmaps: any[] = [];
